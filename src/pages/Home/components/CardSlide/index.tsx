...
const MovieSlideGroup = () => {
  const { data: nowPlaying } = getNowPlayData()
  const { data: topRated } = getTopratedData()
  const { data: upComing } = getUpcomingData()
...
export default MovieSlideGroup
